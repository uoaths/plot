...
impl GridPercent {
    pub fn new(investment: QuoteQuantity, range: Range<Price>, percent: Decimal) -> Self {
        Self {
            investment,
            range,
            percent,
    ...
    fn assign_position(&self) -> Vec<Position> {
        ...
        for i in 0..prices.len() {
            ...
            positions.push(Position {
                ...
                selling_prices: vec![Range(sell_0, termination_price.clone())],
...
mod tests {
    ...
    #[test]
    fn test_positions() {
        let grid = GridPercent::new(dec("100"), Range(dec("50"), dec("60")), dec("0.01"));
        ...
        let grid = GridPercent::new(dec("100"), Range(dec("100"), dec("200")), dec("0.05"));
        let positions = grid.assign_position();
